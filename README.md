...
### Usage
1) Build the Debug version of the project using Visual Studio.
2) Copy the compiled proxy ddraw.dll to the game folder (where tp_win32.exe is located) or download the precompiled .dll from the Releases. 
